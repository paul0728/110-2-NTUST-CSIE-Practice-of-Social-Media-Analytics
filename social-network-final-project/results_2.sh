...
#Declare a string array
DatasetArray=("./gemsec_facebook_dataset/facebook_clean_data/athletes_edges.csv" \
...
python Facebook_Link_Prediction_paper.py --embedding "DeepWalk" --dataset_path "./gemsec_facebook_dataset/facebook_clean_data/artist_edges.csv"
python Facebook_Link_Prediction_paper.py --embedding "DeepWalkWithRegularization" --dataset_path "./gemsec_facebook_dataset/facebook_clean_data/artist_edges.csv"
python Facebook_Link_Prediction.py --PCA --dataset_path "./gemsec_facebook_dataset/facebook_clean_data/artist_edges.csv" 
python Facebook_Link_Prediction.py --dataset_path "./gemsec_facebook_dataset/facebook_clean_data/artist_edges.csv"
